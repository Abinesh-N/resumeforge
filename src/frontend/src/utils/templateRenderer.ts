...
function renderPersonalInfo(
  ...
  style: "centered" | "left" | "split" = "left",
) {
  if (style === "centered") {
    return `
...
function renderExperience(experience: ResumeContent["experience"]) {
...
function renderEducation(education: ResumeContent["education"]) {
...
function renderProjects(projects: ResumeContent["projects"]) {
...
function templateModernClean(content: ResumeContent): string {
...
function templateProfessionalExec(content: ResumeContent): string {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
    ${baseStyles}
...
function templateCreativeBold(content: ResumeContent): string {
...
function templateMinimalZen(content: ResumeContent): string {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
    ${baseStyles}
...
function templateTwoColumn(content: ResumeContent): string {
  const info = content.personalInfo;
  const sidebar = `
...
function templateAcademic(content: ResumeContent): string {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
    ${baseStyles}
...
function templateStartupModern(content: ResumeContent): string {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
    ${baseStyles}
...
function templateElegantDark(content: ResumeContent): string {
  const info = content.personalInfo;
  return `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
    ${baseStyles}
    body { background: #fff; }
