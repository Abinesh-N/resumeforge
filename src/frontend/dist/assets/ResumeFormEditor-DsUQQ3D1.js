import { r as reactExports, j as jsxRuntimeExports, d as useParams, b as useNavigate, c as ue } from "./index-twaNkWBq.js";
import { B as Badge } from "./badge-B6UcY6kV.js";
import { c as createLucideIcon, u as useComposedRefs, a as cn, B as Button } from "./createLucideIcon-C7JxXydK.js";
import { d as Presence, P as Primitive, u as useControllableState, c as composeEventHandlers, e as useSize, b as createContextScope } from "./index-D34DepkZ.js";
import { C as Check } from "./check-BLsQ0cCJ.js";
import { I as Input } from "./input-CuTyS7TI.js";
import { L as Label } from "./label-Ds2VxA7k.js";
import { S as Separator } from "./separator-C8a_aty2.js";
import { S as Skeleton } from "./skeleton-CSD9JFy2.js";
import { e as useGetResume, c as useGetTemplates, f as useUpdateResume } from "./useBackend-QfFKXp8l.js";
import { u as useResumeEditor, C as ChevronLeft } from "./useResumeEditor-BoIDdRVB.js";
import { D as Download, g as generatePDF } from "./pdfGenerator-DrdGieLq.js";
import { r as renderTemplate, T as TEMPLATE_IDS } from "./templateRenderer-C4YBmo0g.js";
import { U as User } from "./user-blf5ZQGb.js";
import { S as Save } from "./save-DhxwNfQK.js";
...
function setNestedField(content, path, value) {
  ...
  if ((parts[0] === "experience" || parts[0] === "education" || parts[0] === "projects") && parts.length === 3) {
    const arr = result[parts[0]];
    ...
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `absolute bottom-0 inset-x-0 py-0.5 text-[9px] font-medium text-center truncate px-1 ${active ? "bg-primary text-primary-foreground" : "bg-muted/80 text-muted-foreground"}`,
...
function ResumeFormEditor() {
  ...
  const [clickEditMode, setClickEditMode] = reactExports.useState(false);
  const [floatingInput, setFloatingInput] = reactExports.useState(
    null
  );
  ...
  const previewContentRef = reactExports.useRef(null);
  const floatingInputRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    ...
    const handleClick = (e) => {
      ...
      const isMulti = fieldPath.includes("description") || fieldPath.includes("summary");
      const containerRect = ((_a = previewContainerRef.current) == null ? void 0 : _a.getBoundingClientRect()) ?? {
        top: 0,
        left: 0
      };
      ...
      const scrollTop = ((_b = previewContainerRef.current) == null ? void 0 : _b.scrollTop) ?? 0;
      const relativeRect = {
  ...
  reactExports.useEffect(() => {
    if (floatingInput && floatingInputRef.current) {
      ...
      if (floatingInputRef.current instanceof HTMLInputElement) {
        ...
        const ta = floatingInputRef.current;
  ...
  const handleFloatingKeyDown = (e) => {
    if (!(floatingInput == null ? void 0 : floatingInput.isTextarea) && e.key === "Enter") {
      e.preventDefault();
      commitFloatingEdit();
    }
    if (e.key === "Escape") {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      className: [
                        ...
                        clickEditMode ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"
                      ].join(" "),
                      title: clickEditMode ? "Exit click-to-edit mode" : "Enable click-to-edit mode",
                      children: [
                ...
                clickEditMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/8 border-b border-primary/20 px-4 py-2 flex items-center gap-2 text-xs text-primary shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MousePointerClick, { className: "w-3.5 h-3.5 shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Click any text on the resume to edit it directly" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary/60 ml-1", children: "· Press Esc or click outside to cancel · Enter to save" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      clickEditMode && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "style",
                        {
                      ...
                      floatingInput && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            floatingInput.isTextarea ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "textarea",
                              {
                                ref: (el) => {
                                ...
                                onChange: (e) => setFloatingInput(
                                  (fi) => fi ? { ...fi, value: e.target.value } : fi
                                ),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-[10px] text-primary/70 bg-primary/10 rounded px-2 py-0.5 inline-block", children: floatingInput.isTextarea ? "Ctrl+Enter · Esc" : "Enter · Esc" })
                          ]
                        }
                      )
                    ]
