...
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "Creative" in value ? "Creative" : "Minimal" in value ? "Minimal" : "Professional" in value ? "Professional" : "Modern" in value ? "Modern" : value;
}
