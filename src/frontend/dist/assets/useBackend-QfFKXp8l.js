...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, h as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, i as RequestStatusResponseStatus, U as UnknownError, k as RequestStatusDoneNoReplyErrorCode, m as RejectError, n as CertifiedRejectErrorCode, o as UNREACHABLE_ERROR, I as InputError, p as InvalidReadStateRequestErrorCode, q as ReadRequestType, t as Principal, v as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, B as isV2ResponseBody, D as UncertifiedRejectUpdateErrorCode, F as UnexpectedErrorCode, G as decode, S as Subscribable, J as pendingThenable, K as resolveEnabled, N as shallowEqualObjects, O as resolveStaleTime, V as noop, W as environmentManager, X as isValidTimeout, Y as timeUntilStale, Z as timeoutManager, $ as focusManager, a0 as fetchState, a1 as replaceData, a2 as notifyManager, a3 as hashKey, a4 as getDefaultState, r as reactExports, a5 as shouldThrowError, a as useQueryClient, u as useInternetIdentity, a6 as createActorWithConfig, a7 as Variant, a8 as Record, a9 as Opt, aa as Vec, ab as Service, ac as Func, ad as Text, ae as Null, af as Nat, ag as Int, ah as Bool, ai as Nat8 } from "./index-twaNkWBq.js";
...
const UserId = Text;
const ResumeId = Text;
const PaymentRecordView = Record({
  "id": PaymentId,
...
const CreatePaymentInput = Record({
  "resumeId": ResumeId,
  "stripePaymentIntentId": Text,
  "amount": Nat
});
const ProjectEntry = Record({
  "title": Text,
  "link": Text,
  "description": Text
});
...
const CreateResumeInput = Record({
  "title": Text,
  "content": ResumeContent,
  "templateId": TemplateId
});
const ResumeView = Record({
  "id": ResumeId,
  "title": Text,
  "content": ResumeContent,
  "ownerId": UserId,
...
const TemplateCategory$1 = Variant({
  "Creative": Null,
  "Minimal": Null,
  "Academic": Null,
  "Executive": Null,
...
const UpdateResumeInput = Record({
  "id": ResumeId,
  "title": Text,
  "content": ResumeContent,
  "templateId": TemplateId
...
Service({
  "confirmPayment": Func([PaymentId], [PaymentRecordView], []),
  "createCheckoutSession": Func(
    [Vec(ShoppingItem), Text, Text],
    [Text],
    []
  ),
  "createPaymentRecord": Func(
    [CreatePaymentInput],
    [PaymentRecordView],
    []
  ),
  "createResume": Func([CreateResumeInput], [ResumeView], []),
  "deleteResume": Func([ResumeId], [Bool], []),
  "getMyProfile": Func([], [Opt(ProfileView)], []),
  "getMyResumes": Func([], [Vec(ResumeView)], ["query"]),
  "getPaymentHistory": Func([], [Vec(PaymentRecordView)], ["query"]),
  "getResume": Func([ResumeId], [Opt(ResumeView)], ["query"]),
  "getStripeSessionStatus": Func([Text], [StripeSessionStatus], []),
  "getTemplate": Func([TemplateId], [Opt(Template)], ["query"]),
  "getTemplates": Func([], [Vec(Template)], ["query"]),
  ...
  "updateResume": Func([UpdateResumeInput], [ResumeView], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const PaymentId2 = IDL2.Text;
  ...
  const ResumeId2 = IDL2.Text;
  const PaymentRecordView2 = IDL2.Record({
    "id": PaymentId2,
    "status": PaymentStatus2,
    "unlockedAt": IDL2.Opt(Timestamp2),
    "userId": UserId2,
  ...
  const CreatePaymentInput2 = IDL2.Record({
    "resumeId": ResumeId2,
    "stripePaymentIntentId": IDL2.Text,
    "amount": IDL2.Nat
  });
  const ProjectEntry2 = IDL2.Record({
    "title": IDL2.Text,
    "link": IDL2.Text,
  ...
  const PersonalInfo2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "summary": IDL2.Text,
    "phone": IDL2.Text,
  ...
  const ResumeContent2 = IDL2.Record({
    "projects": IDL2.Vec(ProjectEntry2),
    "education": IDL2.Vec(EducationEntry2),
    "experience": IDL2.Vec(ExperienceEntry2),
    "personalInfo": PersonalInfo2,
    "skills": IDL2.Vec(IDL2.Text)
  });
  const TemplateId2 = IDL2.Text;
  const CreateResumeInput2 = IDL2.Record({
    "title": IDL2.Text,
    "content": ResumeContent2,
    "templateId": TemplateId2
  });
  const ResumeView2 = IDL2.Record({
    "id": ResumeId2,
    "title": IDL2.Text,
    "content": ResumeContent2,
    "ownerId": UserId2,
  ...
  const TemplateCategory2 = IDL2.Variant({
    "Creative": IDL2.Null,
    "Minimal": IDL2.Null,
    "Academic": IDL2.Null,
    "Executive": IDL2.Null,
    "Professional": IDL2.Null,
    "StartupTech": IDL2.Null,
    "TwoColumn": IDL2.Null,
    "Modern": IDL2.Null
  });
  ...
  const UpdateResumeInput2 = IDL2.Record({
    "id": ResumeId2,
    "title": IDL2.Text,
    "content": ResumeContent2,
    "templateId": TemplateId2
  ...
  return IDL2.Service({
    "confirmPayment": IDL2.Func([PaymentId2], [PaymentRecordView2], []),
    "createCheckoutSession": IDL2.Func(
      [IDL2.Vec(ShoppingItem2), IDL2.Text, IDL2.Text],
      [IDL2.Text],
      []
    ),
    "createPaymentRecord": IDL2.Func(
      [CreatePaymentInput2],
      [PaymentRecordView2],
      []
    ),
    "createResume": IDL2.Func([CreateResumeInput2], [ResumeView2], []),
    "deleteResume": IDL2.Func([ResumeId2], [IDL2.Bool], []),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(ProfileView2)], []),
    "getMyResumes": IDL2.Func([], [IDL2.Vec(ResumeView2)], ["query"]),
    "getPaymentHistory": IDL2.Func([], [IDL2.Vec(PaymentRecordView2)], ["query"]),
    "getResume": IDL2.Func([ResumeId2], [IDL2.Opt(ResumeView2)], ["query"]),
    ...
    "getTemplates": IDL2.Func([], [IDL2.Vec(Template2)], ["query"]),
    ...
    "updateResume": IDL2.Func([UpdateResumeInput2], [ResumeView2], [])
  });
};
...
var TemplateCategory = /* @__PURE__ */ ((TemplateCategory2) => {
  ...
  TemplateCategory2["Minimal"] = "Minimal";
  TemplateCategory2["Academic"] = "Academic";
  TemplateCategory2["Executive"] = "Executive";
  TemplateCategory2["Professional"] = "Professional";
  TemplateCategory2["StartupTech"] = "StartupTech";
  TemplateCategory2["TwoColumn"] = "TwoColumn";
  TemplateCategory2["Modern"] = "Modern";
...
class Backend {
  ...
  async createPaymentRecord(arg0) {
    if (this.processError) {
      try {
...
function from_candid_PaymentRecordView_n1(_uploadFile, _downloadFile, value) {
  return from_candid_record_n2(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentStatus_n3(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function from_candid_ProfileView_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_StripeSessionStatus_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_TemplateCategory_n18(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
function from_candid_Template_n16(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "Creative" in value ? "Creative" : "Minimal" in value ? "Minimal" : "Academic" in value ? "Academic" : "Executive" in value ? "Executive" : "Professional" in value ? "Professional" : "StartupTech" in value ? "StartupTech" : "TwoColumn" in value ? "TwoColumn" : "Modern" in value ? "Modern" : value;
}
...
function useGetResume(resumeId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useCreatePaymentRecord() {
  const { actor } = useActor(createActor);
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (input) => {
...
function useGetStripeSessionStatus() {
  const { actor } = useActor(createActor);
  return useMutation({
...
export {
  PaymentStatus as P,
  TemplateCategory as T,
  useGetPaymentHistory as a,
  useDeleteResume as b,
  useGetTemplates as c,
  useCreateResume as d,
  useGetResume as e,
  useUpdateResume as f,
  useIsStripeConfigured as g,
  useCreateCheckoutSession as h,
  useSetStripeConfiguration as i,
  useGetStripeSessionStatus as j,
  useCreatePaymentRecord as k,
  useConfirmPayment as l,
  useGetMyProfile as m,
  useUpdateMyProfile as n,
  useGetMyResumes as u
};
